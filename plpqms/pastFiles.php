          ...
          <div class="card mb-4 wow fadeIn rounded-4 ">
            ...
            <div class="card-body d-sm-flex justify-content-between shadow bg-light rounded-4 ">
              ...
              <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4 ">
                ...
                <span>|</span>
                <span style="color: #E0A100;">ALL RECENT DOCUMENTS</span>
              </h4>
              <!-- 
              ...
              <div class="form-group me-2">
                <select class="d-inline-block form-select fw-bold btn waves-effect waves-light pe-5 rounded-4 "
                  ...
                  style="background-color: #E0A100;"><i class="fas fa-file-medical">
                    ...
                    <option value="all" <?php if ($department == 'all')
                      echo 'selected'; ?>>All Department</option>
                    <?php
                    require_once ("connection.php");
                    ...
                    while ($file = mysqli_fetch_assoc($result)) {
                      ...
                      ?>
                      <option value="<?php echo $offices; ?>" <?php if ($department == $offices)
                           echo 'selected'; ?>>
                        <?php echo $offices; ?></option> <?php } ?>
              ...
              <div class="form-group">
                <select class="d-inline-block form-select fw-bold btn waves-effect waves-light pe-5 rounded-4 "
                  ...
                  style="background-color: #E0A100;"><i class="fas fa-file-medical">
                    ...
                    <option value="all" <?php if ($actions == 'all')
                      echo 'selected'; ?>>All</option>
                    <option value="Approved" <?php if ($actions == 'Approved')
                      echo 'selected'; ?>>Approved</option>
                    <option value="Rejected" <?php if ($actions == 'Rejected')
              ...
              <div class="input-group">
                ...
                <span class="input-group-btn">
                  <a href="archiveFiles1.php" class="text-black">
                    <button class="d-inline-block fw-bold btn waves-effect waves-light ms-2 rounded-4 "
                      style="background-color: #E0A100;">Archived Documents</button>
                  </a>
                </span>
                    ...
                    <tr>
                      ...
                      <td width="10%">
                        ...
                        <a href="downloads.php?file_id=<?php echo $id; ?>" onclick="downloadYes(event)"
                          class="btn btn-sm btn-outline-success"><i class="fa fa-download"></i>
                          <script>
                        ...
                        <a href="archive.php?ID=<?php echo $id; ?>" class="btn btn-sm btn-outline-danger"
                          onclick="yesNO(event)"><i class="fa fa-archive
                                        "></i>
                          <script>
                            function yesNO(ev) {
                              document.querySelector("body").style.overflow = 'hidden';
    ...
    function load_unseen_notification(view = '') {
        $.ajax({
            ...
            error: function (xhr, status, error) {
                console.error(xhr.responseText); // Add this line to log any errors
            }
        });
    }
