...
<body>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol id="right"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024"
        height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <symbol id="left"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024"
        height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  <div class="row d-md-block w-100 ms-0">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 pt-4 float-start" style="background-color: green;" id="sidebar">
      ...
      <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
        ...
        <li>
          <a href="dashboard.php" class="nav-link" style="color: #ffffff;">
            <svg class="bi pe-none me-2" width="16" height="16" >
      ...
      <li>
          <a href="pastFiles.php" class="nav-link text-white" style="background-color: rgba(202, 202, 202, .65); color: #fff;">
          <svg class=" bi pe-none me-2" width="16" height="16">
  ...
  <div class="content">
    <div class="row ms-0 w-100" style="position: relative;">
          ...
          <div class="card mb-4 wow fadeIn rounded-4 ">
            ...
            <div class="card-body d-sm-flex justify-content-between shadow bg-light rounded-4 ">
              ...
              <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4 ">
                <span style="text-decoration: none; color:green; ">MANAGE ALL FILES</span>
                <span>|</span>
      ...
      <?php
            ...
            $query100 = "SELECT * FROM upload_files WHERE ARCHIVE = '1' AND 1=1";
      ...
      <div class="col-md-12 headertop ms-0">
        <div class="container-fluid">
          ...
          <div class="d-flex">
            <form class="d-flex" action="archiveFiles1.php" id="manageFiles" method="POST">
              <div class="form-group me-2">
                  <select class="d-inline-block form-select fw-bold btn waves-effect waves-light pe-5 rounded-4 "
                    onchange="folder();" name="department" aria-label="Default select example"
                    style="background-color: #E0A100;"><i class="fas fa-file-medical">
              ...
              <div class="form-group">
                  <select class="d-inline-block form-select fw-bold btn waves-effect waves-light pe-5 rounded-4 "
                    onchange="folder();" name="actions" aria-label="Default select example"
                    style="background-color: #E0A100;"><i class="fas fa-file-medical">
              ...
              <div class="input-group">
                <span class="input-group-btn">
                  <a href="pastFiles.php" class="text-black">
                    <button class="d-inline-block fw-bold btn waves-effect waves-light rounded-4 me-2"
                      style="background-color: #E0A100;">
                        <svg class="" width="20" height="20">
                        <use xlink:href="#left" />
                      </svg>
                      Back to Manage All Files
                    </button>
                  </a>
                </span>
                <span class="input-group-btn">
                <a href="ceatfolder.php" class="text-black">
                    <button class="d-inline-block fw-bold btn waves-effect waves-light rounded-4 "
                      style="background-color: #E0A100;">
                      Old Documents
                      <svg class="" width="20" height="20">
                  ...
                  if ($result100) {
                      while ($file = mysqli_fetch_array($result100)) {
                          ...
                          <tr>
                                  ...
                                  <td width="10%">
                                    <a href='view_document.php?controlNumber=<?php echo $controlid; ?>' onclick="viewDocument(event)"
                                    ...
                                    <a href='unarchive.php?file_id=<?php echo $id; ?>' onclick="downloadYes(event)"
                                      class="btn btn-sm btn-outline-success"><i class="fa fa-upload"></i>
                                      <script>
                                    ...
                                    <a href="delete.php?ID=<?php echo $id; ?>" class="btn btn-sm btn-outline-danger" onclick="yesNO(event)">
