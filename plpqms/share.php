      ...
      <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
        ...
        <li>
          ...
          <ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3"
            ...
            <li>
              <a href="privatefiles.php" class="nav-link dropdown-item text-white" style="background-color: rgba(202, 202, 202, .65);">
            ...
            <div class="form-floating mb-3">
              ...
              <datalist class="" aria-label="Default select example" id="emailemployee" required style="display: none;">
                ...
                while ($file = mysqli_fetch_assoc($result)) {
                  ...
                  <option name="sentuser" value="<?php echo $sendUser; ?>">Send to User Acc: <?php echo $sendUser; ?>
                  </option> <?php } ?>
                ...
                while ($file1 = mysqli_fetch_assoc($result1)) {
                  ...
                  <option name="sentuser1" value="<?php echo $sendUser1; ?>">Send to Admin Acc: <?php echo $sendUser1; ?>
                  </option> <?php } ?>
