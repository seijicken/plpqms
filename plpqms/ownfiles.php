...
<head>
  ...
  <title>PLP | QMS Add Documents</title>
...
<body>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol id="folder" viewBox="0 0 16 16"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol id="addrescard"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="1.9em" xmlns="http://www.w3.org/2000/svg"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
        <path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm80 256h64c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16c0-44.2 35.8-80 80-80zm96-96c0 35.3-28.7 64-64 64s-64-28.7-64-64s28.7-64 64-64s64 28.7 64 64zm128-32H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16z" />
      </svg></symbol>
    <symbol id="userclock"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><!-- Font Awesome Pro 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) -->
    ...
    <symbol id="building"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol id="user"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
        <path d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0S96 57.3 96 128s57.3 128 128 128zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z" />
      </svg></symbol>
    <symbol id="history"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
        <path d="M75 75L41 41C25.9 25.9 0 36.6 0 57.9V168c0 13.3 10.7 24 24 24H134.1c21.4 0 32.1-25.9 17-41l-30.8-30.8C155 85.5 203 64 256 64c106 0 192 86 192 192s-86 192-192 192c-40.8 0-78.6-12.7-109.7-34.4c-14.5-10.1-34.4-6.6-44.6 7.9s-6.6 34.4 7.9 44.6C151.2 495 201.7 512 256 512c141.4 0 256-114.6 256-256S397.4 0 256 0C185.3 0 121.3 28.7 75 75zm181 53c-13.3 0-24 10.7-24 24V256c0 6.4 2.5 12.5 7 17l72 72c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-65-65V152c0-13.3-10.7-24-24-24z" />
      </svg></symbol>
    <symbol id="userPlus"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
        <path d="M352 128c0 70.7-57.3 128-128 128s-128-57.3-128-128S153.3 0 224 0s128 57.3 128 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM504 312V248H440c-13.3 0-24-10.7-24-24s10.7-24 24-24h64V136c0-13.3 10.7-24 24-24s24 10.7 24 24v64h64c13.3 0 24 10.7 24 24s-10.7 24-24 24H552v64c0 13.3-10.7 24-24 24s-24-10.7-24-24z" />
      </svg></symbol>
    <symbol id="users"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol id="email"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
        <path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z" />
      </svg></symbol>
    <symbol id="lock"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
        <path d="M144 144v48H304V144c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192V144C80 64.5 144.5 0 224 0s144 64.5 144 144v48h16c35.3 0 64 28.7 64 64V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V256c0-35.3 28.7-64 64-64H80z" />
      </svg>
    </symbol>
    <symbol id="notif"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
        <path d="M224 0c-17.7 0-32 14.3-32 32V51.2C119 66 64 130.6 64 208v18.8c0 47-17.3 92.4-48.5 127.6l-7.4 8.3c-8.4 9.4-10.4 22.9-5.3 34.4S19.4 416 32 416H416c12.6 0 24-7.4 29.2-18.9s3.1-25-5.3-34.4l-7.4-8.3C401.3 319.2 384 273.9 384 226.8V208c0-77.4-55-142-128-156.8V32c0-17.7-14.3-32-32-32zm45.3 493.3c12-12 18.7-28.3 18.7-45.3H224 160c0 17 6.7 33.3 18.7 45.3s28.3 18.7 45.3 18.7s33.3-6.7 45.3-18.7z" />
      </svg></symbol>
    <symbol id="question"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
        <path d="M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512zM169.8 165.3c7.9-22.3 29.1-37.3 52.8-37.3h58.3c34.9 0 63.1 28.3 63.1 63.1c0 22.6-12.1 43.5-31.7 54.8L280 264.4c-.2 13-10.9 23.6-24 23.6c-13.3 0-24-10.7-24-24V250.5c0-8.6 4.6-16.5 12.1-20.8l44.3-25.4c4.7-2.7 7.6-7.7 7.6-13.1c0-8.4-6.8-15.1-15.1-15.1H222.6c-3.4 0-6.4 2.1-7.5 5.3l-.4 1.2c-4.4 12.5-18.2 19-30.6 14.6s-19-18.2-14.6-30.6l.4-1.2zM288 352c0 17.7-14.3 32-32 32s-32-14.3-32-32s14.3-32 32-32s32 14.3 32 32z" />
      </svg></symbol>
    <symbol id="key"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
        <path d="M512 176.001C512 273.203 433.202 352 336 352c-11.22 0-22.19-1.062-32.827-3.069l-24.012 27.014A23.999 23.999 0 0 1 261.223 384H224v40c0 13.255-10.745 24-24 24h-40v40c0 13.255-10.745 24-24 24H24c-13.255 0-24-10.745-24-24v-78.059c0-6.365 2.529-12.47 7.029-16.971l161.802-161.802C163.108 213.814 160 195.271 160 176 160 78.798 238.797.001 335.999 0 433.488-.001 512 78.511 512 176.001zM336 128c0 26.51 21.49 48 48 48s48-21.49 48-48-21.49-48-48-48-48 21.49-48 48z" />
      </svg></symbol>
    <symbol id="add"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol id="signout"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="row d-md-block w-100 ms-0">
    <div class="d-flex flex-column flex-shrink-0 p-3 pt-4 float-start" style="background-color: green;" id="sidebar">
      ...
      <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
        ...
        <li>
          <a href="#" class="nav-link text-white dropdown-toggle" style="background-color: rgba(202, 202, 202, .65);" data-bs-toggle="dropdown" aria-expanded="false">
            <svg class="bi pe-none me-2" width="16" height="16">
              <use xlink:href="#user" />
            </svg>
            <?php echo ucwords(htmlentities($username)); ?> Files
          </a>
          <ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3" style="background-color: green;">
            <li>
            ...
            <li>
              <a href="ownfiles.php" class="nav-link dropdown-item text-white" style="background-color: rgba(202, 202, 202, .65);">
      ...
      <div class="dropdown" id="namePosition">
        ...
        <ul class="dropdown-menu dropdown-menu-dark text-small shadow" id="logout">
          <li><a class="dropdown-item" href="#" onclick="confirmSignOut()">Sign out <svg class="bi pe-none me-2" width="16" height="16">
    ...
    <header class="ms-0 w-100 py-4 mb-6 border-bottom border-5 border-warning" style="height: 80px; z-index: -1">
      <div class="dropstart float-end">
        <li class="dropdown" style="list-style: none;">
          ...
          <a href="#" class="dropdown-toggle text-light text-decoration-none" id="notiftoggle" data-bs-toggle="dropdown" aria-expanded="false"><span class="badge rounded-pill bg-danger count" style="border-radius:10px;"></span><svg class="me-4" width="20" height="18">
              <use xlink:href="#notif" />
            </svg>
          </a>
          <ul class="dropdown-menu border-top border-start border-end border-dark border-bottom border-4 rounded-3" id="dropnotif" style="text-decoration: none; background-color: #E0A100; color:black; width: 350px; height: 400px; overflow-x:hidden; overflow-y: auto; ">
          </ul>
  ...
  <div class="pt-3 ms-0 w-100 mb-6 border-bottom border-5 border-warning" id="customMenu" style="background-color: green; height: 80px; ">
    <div class="container-fluid">
      ...
      <div class="mt-2 dropstart float-end">
        <li class="dropdown" style="list-style: none;">
          <span class="text-light px-3">Welcome, Admin</span>
          <a href="#" class="dropdown-toggle text-light text-decoration-none" id="notiftoggle1" data-bs-toggle="dropdown" aria-expanded="false"><span class="badge rounded-pill bg-danger count1" style="border-radius:10px;"></span><svg class="me-4" width="20" height="18">
              <use xlink:href="#notif" />
            </svg>
          </a>
          <ul class="dropdown-menu border-top border-start border-end border-dark border-bottom border-4 rounded-3" id="dropnotif1" style="text-decoration: none; background-color: #E0A100; color:black; width: 350px; height: 400px; overflow-x:hidden; overflow-y: auto; ">
          </ul>
            ...
            <div class="card-body d-sm-flex justify-content-between shadow bg-light rounded-4">
              ...
              <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
                <a style="text-decoration: none; color:green; ">
                  <?php echo strtoupper(htmlentities($username)); ?> FILES</a>
                <span>|</span>
                <span style="color: #E0A100;">IN PROGRESS FILES</span>
              </h4>
              <!-- 
          ...
          <div class="table-responsive">
            <table id="dtable" class="table table-striped w-100">
              ...
              <tbody>
                ...
                $query = "SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,SIZE,DESCRIPTION,SENDTO,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD,file_status FROM upload_files WHERE (EMAIL ='$id' AND SENDTO !='Private' AND ARCHIVE ='0' AND file_status = 'In Progress') group by ID DESC";
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <!-- <a href="history.php?file_id=<?php echo $controlid; ?>" class="btn btn-sm btn-outline-success"><i
                      ...
                      <!-- <button type="button" class="btn btn-sm btn-outline-success" data-bs-toggle="modal" data-bs-target="#staticBackdrop100">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h1 class="modal-title fs-5" id="staticBackdropLabel">Verification</h1>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <p>Are you Sure?</p>
                                <a href='approval.php?file_id=<?php echo $id; ?>' onclick="approval(event)"
                                  class="btn btn-primary">Yes
                                  <script>
                                    function approval(evs) {
                                      document.querySelector("body").style.overflow = 'hidden';
                                      evs.preventDefault();
                                      var urlToRedirect = evs.currentTarget.getAttribute('href');
                                      window.location.href = urlToRedirect;
                                      Swal.fire({
                                        icon: 'success',
                                        title: 'Approved!!',
                                        text: 'Your Requested File is Now Approved.',
                                        showConfirmButton: false,
                                        timer: 7000
                                      }).then(function () {
                                      })
                      ...
                      <a href='view_document.php?controlNumber=<?php echo $controlid; ?>' onclick="viewDocument(event)" class="btn btn-sm btn-outline-primary"><i class="fa fa-eye"></i></a>
                      <script>
                      ...
                      <a href="approval.php?file_id=<?php echo $id; ?>" class="btn btn-sm btn-outline-success" id="approveBtn" onclick="approved(event)"><i class="fa-solid fa-circle-check"></i>
                        <script>
                          function approved(ev) {
                            document.querySelector("body").style.overflow = 'hidden';
                            ev.preventDefault();
                            ...
                            swalWithBootstrapButtons.fire({
                              title: '<strong style="color: green;">SIGNATURE IDENTIFICATION</strong>',
                              html: `
        <img src="img/signature.png" style="width: 150px; height: 150px;"> <br><br>
        <input type="file" class="form-control-file mb-3 border border-secondary" id="fileInput" accept="image/*"> <br>
        <button type="button" class="btn btn-warning w-25 mb-2" onclick="uploadFile('${urlToRedirect}')">UPLOAD</button>
      `,
                              showCancelButton: true,
                          ...
                          function uploadFile(urlToRedirect) {
                            ...
                            fetch('upload_endpoint.php', {
                              ...
                              .then(data => {
                                if (data.success) {
                                  Swal.fire({
                                    ...
                                    text: 'Your image has been successfully uploaded with a percentage of 100%.',
                                    icon: 'success',
                                    confirmButtonText: 'OK'
                                  }).then(() => {
                                    // Redirect to approval.php
                                    window.location.href = urlToRedirect;
                                    document.querySelector("body").style.overflow = 'visible';
                                  });
                                } else {
                              ...
                              .catch(error => {
                                ...
                                Swal.fire('Upload Failed', `There was an issue uploading your file. Please try again. Error: ${error.message}`, 'error');
                              });
                          }
                        </script>
                      </a>
                      <a href="rejected.php?ID=<?php echo $id; ?>" class="btn btn-sm btn-outline-danger" onclick="yesNO(event)"><i class="fa fa-archive"></i>
                        <script>
                          function yesNO(ev) {
                            document.querySelector("body").style.overflow = 'hidden';
                            ev.preventDefault();
                            ...
                            swalWithBootstrapButtons.fire({
                              title: 'Are you sure?',
                              text: "You want to reject this file?",
                              icon: 'warning',
                              showCancelButton: true,
                              cancelButtonText: 'No, cancel!',
  ...
  <div class="modal fade rounded-5" id="modalRegisterForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
