...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" inte
    grity="sha512-SnH5WK+bZxgPHs44uWIX+LLJAJ9/2PkPKZ5QiAj6Ta86w+fsb2TkcmfRyVX3pBnMFcV7oQPJkl9QevSCWr3W6A=="
    crossorigin="anonymous" referrerpolicy="no-referrer" />
  <title>PLP | QMS Homepage</title>
...
<body>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol id="settings-icon" viewBox="0 0 16 16" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm6 14h-4v4h-2v-4H6v-2h4V8h2v4h4v2zM10 18H8v-2h2v2zm0-5H8V8h2v5zm5-18v2h-2V8h2zM12 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm0 1a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm0 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm5 3a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm-5 3a1 1 0 1 1 0 2 1 1 0 0 1 0-2z" />
    </symbol>
  </svg>
  ...
  <div class="row d-md-block w-100 ms-0 ">
    <div class="d-flex flex-column flex-shrink-0 p-3 pt-4 float-start" style="background-color: green;" id="sidebar">
      ...
      <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
        <li class="nav-item">
          <a href="home.php" class="nav-link text-white" style="background-color: rgba(202, 202, 202, .65);"
            aria-current="page">
  ...
  <div class="collapse" id="navbarToggleExternalContent" style="background-color: green;">
    <div class="dark p-4">
      ...
      <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
        ...
        <li>
          <a href="settings.php" class="nav-link text-white">
            <i class="fa-sharp fa-gear pe-0 me-2" style="color: #ffffff;"></i>
            Settings
          </a>
        </li>
        </li>
        ...
        <div class="container-fluid" style="visibility: hidden; display: none;" id="piechart_download">
          <div class="card mb-4 shadow bg-light rounded-4">
            ...
            <div class="card-body text-center p-4">
              ...
              <h1 class="display-1 fw-bold"><?php if ($sum != 0) {
                echo $sum;
              } else {
                echo "0";
              } ?></h1>
        ...
        <div class="container-fluid col-md-12 rounded-4" id="piechart_upload">
          <div class="card mb-4 shadow bg-light rounded-4">
            ...
            <div class="card-body text-center p-4">
              ...
              <h1 class="display-1 fw-bold"><?php if ($sumUp != 0) {
                echo $sumUp;
              } else {
                echo "0";
              } ?></h1>
              <button class="btn btn-outline-warning btn-sm float-end rounded-3" id="btnHide">
        ...
        <div class="container-fluid mt-0 rounded-4">
          <div class="ms-0 card shadow bg-light rounded-4">
            ...
            <div class=" ms-0 card-body">
              ...
              ?>
              <CENTER>
                <h3 class="page-header fw-bold">Monthly Upload | Report </h3>
              </CENTER>
        ...
        <div class="container-fluid mt-0">
          <div class="ms-0 card shadow bg-light rounded">
            ...
            <div class=" ms-0 card-body">
              ...
              ?>
              <CENTER>
                <h3 class="page-header fw-bold">Monthly Download | Report</h3>
              </CENTER>
