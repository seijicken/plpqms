   ...
   <div class="container-fluid mt-5 rounded-4">
      ...
      <div class="card mb-4 wow fadeIn rounded-4">
        ...
        <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
            <span style="color: #E0A100;">BASELINE FILE</span>
          </h4>
<!-- 
    ...
    <th class="desktop">Action</th>
     ...
     <?php
      ...
      <td><?php echo $download; ?></td>
                 ...
                 <a href='view_document.php?controlNumber=<?php echo $id; ?>' onclick="viewDocument(event)" class="btn btn-sm btn-outline-primary"><i class="fa fa-eye"></i></a>
<script>
  ...
  -->
                  <a href="share.php?id=<?php echo  $id;?>" class="btn btn-sm btn-outline-success"><i class="fa fa-share"></i></a>
