      ...
      <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
        ...
        <li>
          ...
          <ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3" style="background-color: green;" >
            <li>
              <a href="add_file.php" class="nav-link dropdown-item text-white"  style="background-color: rgba(202, 202, 202, .65);">
                      ...
                      <form action="fileprocess.php" id="add_form" method="post" enctype="multipart/form-data">
                        <div class="col-md-11">
                          <div class="md-form mb-0 text-center ms-5">
                            <input type="hidden" name="email" value="<?php echo ucwords(htmlentities($id)); ?>"
                          ...
                          <div class="col-md-10 mt-4">
                            <div class="input-group">
                              ...
                              <input type="file" class="form-control fw-bold rounded-3" id="myFileUpload"
                                ...
                                aria-label="Upload" accept=".pdf" required>
