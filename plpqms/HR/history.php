...
<html lang="en">
  <head>
    ...
    <title>PLP | QMS File History</title>
...
<div class="container-fluid">
   ...
   <a href="ownfiles.php"><button type="button" class=" ms-1 btn btn-success waves-effect rounded-4 waves-light">Go Back to In Progress Files</button></a>
    <hr>
    </div>
  </div>
  <div class="col-md-12">
