...
<head>
  ...
  <title>PLP | QMS In Progress File</title>
    ...
    <div class="row ms-0 mt-5 w-100" style="position: relative;">
          ...
          <div class="table-responsive">
            <table id="dtable" class="table table-striped w-100">
              ...
              <tbody>
                ...
                $query2 = "SELECT * FROM upload_files WHERE (EMAIL ='$id' AND SENTBY !='Private' AND ARCHIVE ='0' AND file_status='In Progress') group by id DESC";
      ...
      `,
                          ...
                          function uploadFile(urlToRedirect) {
                            ...
                            <?php
                              require_once("connection.php");
                              $query3 = "SELECT NAME, DEPARTMENT FROM upload_files WHERE controlNumber = ' $controlid'";
                            ...
                            formData.append('formname', '<?php echo $file_name; ?>');
