...
<div class="container-fluid">
    ...
    <a href="#" data-bs-toggle="modal" data-bs-target="#addOffice"><button type="button" class="btn btn-success waves-effect waves-light rounded-4"><svg class="bi pe-none me-2" width="12" height="16"><use xlink:href="#building"/></svg>Department Offices</button></a>
    <hr>
    </div>
  </div>
  <div class="col-md-12">
...
<label class="ms-2 mb-1"><svg class="" width="20" height="20"><use xlink:href="#building"/></svg>  Designation Office</label>
  ...
  <div class="modal-dialog modal-dialog-centered rounded-5" role="document">
    <div class="modal-content bg-light rounded-5">
      <div class="modal-header text-center rounded-5">
        <h4 class="modal-title w-100 font-weight-bold" style="color: green;"><svg class="" width="32" height="32"><use xlink:href="#building"/></svg> ADD DEPARTMENT OFFICES</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal">
        </button>
      </div>
      <div class="modal-body">
       ...
       <div class="form-floating mb-3">
        ...
        <label for="email"><svg class="" width="20" height="20"><use xlink:href="#building"/></svg>    Department Offices</label>
    </div>      
