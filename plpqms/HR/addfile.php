...
<html lang=" en">
    ...
    <head>
      ...
      <script src='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css'
    ...
    <body>
      ...
      <div class="row d-md-block w-100 ms-0">
        <div class="d-flex flex-column flex-shrink-0 p-3 pt-4 float-start" style="background-color: green;"
          id="sidebar">
        ...
        <header class="ms-0 w-100 py-4 mb-6 border-bottom border-5 border-warning" style="height: 80px; z-index: -1">
          <div class="dropstart float-end">
            <li class="dropdown" style="list-style: none;">
              <a href="#" class="dropdown-toggle text-light text-decoration-none" id="notiftoggle"
                data-bs-toggle="dropdown" aria-expanded="false"><span class="badge rounded-pill bg-danger count"
          ...
          <div class="modal-dialog modal-dialog-centered rounded-5" role="document">
            <div class="modal-content bg-light rounded-5">
              ...
              <div class="modal-body rounded-4">
                ...
                <div class="form-floating mb-3">
                  <input type="text" class="form-control rounded-4" id="email" placeholder="Enter email"
                    name="admin_user">
                  <label for="email"><svg class="" width="20" height="20">
                ...
                <div class="row">
                  <div class="col md-6 form-floating mb-3">
                    <select class="form-select rounded-4" aria-label="Default select example" required
                      name="user_status" onchange="userType(this.value);">
