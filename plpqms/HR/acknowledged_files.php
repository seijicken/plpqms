...
<div class="row d-md-block w-100 ms-0">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1"id="itemSidebar">
      ...
      <li>
        <a href="#" class="nav-link text-white dropdown-toggle" style="background-color: rgba(202, 202, 202, .65);" data-bs-toggle="dropdown" aria-expanded="false"> <!-- color for navi bar -->
      ...
      <ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3" style="background-color: green;"><li>
        ...
        <li>
        <a href="acknowledged_files.php" class="nav-link dropdown-item text-white" style="background-color: rgba(202, 202, 202, .65);">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#folder"/></svg>
           - Acknowledged Files
        </a></li>
        <li>
...
function confirmSignOut() {
    ...
    swalWithBootstrapButtons.fire({
        ...
        <div class="col-md-12 headertop ms-0" style= "background-color: green;" id="headerCustom">
   ...
   <div class="container-fluid mt-5 rounded-4 ">
      ...
      <div class="card mb-4 wow fadeIn rounded-4 ">
        ...
        <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4 ">
            <a href="home.php" style="text-decoration: none; color:green; ">HOME PAGE | <?php echo strtoupper(htmlentities($username)); ?> FILES</a>
            <span>|</span>
