...
<div class="row d-md-block w-100 ms-0">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
      ...
      <!-- <li>
        ...
        <li>
        <a href="addrequests.php" class="nav-link dropdown-item text-white" style="background-color: rgba(202, 202, 202, .65);">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#folder"/></svg>
           - Create Request
        </a></li>
      </ul>
...
<div class="col-md-5 mt-2">
        <input type="text" maxlength="8" onkeypress="{return isNumberKey(event)}" inputmode="numeric" class="form-control rounded-4" id="email" placeholder="Req Control# 8 Digits Only" name="requestid" disabled>
