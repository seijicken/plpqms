...
<head>
  ...
  <title>PLP | QMS View HR Account</title>
  ...
  <style>
    ...
    /* custom css for the signature upload */
    .custom-file-input {
      display: flex;
      align-items: center;
    }
...
<body>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol id="edit"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
        <path d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h274.9c-2.4-6.8-3.4-14-2.6-21.3l6.8-60.9 1.2-11.1 7.9-7.9 77.3-77.3c-24.5-27.7-60-45.5-99.9-45.5zm45.3 145.3l-6.8 61c-1.1 10.2 7.5 18.8 17.6 17.6l60.9-6.8 137.9-137.9-71.7-71.7-137.9 137.8zM633 268.9L595.1 231c-9.3-9.3-24.5-9.3-33.8 0l-37.8 37.8-4.1 4.1 71.8 71.7 41.8-41.8c9.3-9.4 9.3-24.5 0-33.9z" />
      </svg></symbol>
    <symbol id="trash"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
      ...
      <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
        ...
        <li>
          ...
          <ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3" style="background-color: green;">
            ...
            <li>
              <a href="view_hr.php" class="nav-link dropdown-item text-white">
                <svg class="bi pe-none me-2" width="16" height="16">
                  <use xlink:href="#folder" />
                </svg>
                - HR Accounts
            ...
            <li>
              <a href="view_user.php" class="nav-link dropdown-item text-white" style="background-color: rgba(202, 202, 202, .65);">
                <svg class="bi pe-none me-2" width="16" height="16">
                  <use xlink:href="#folder" />
                </svg>
                - Personnel Account
...
-->
    ...
    <div class="row ms-0 w-100" style="position: relative;">
          ...
          <div class="card mb-4 wow fadeIn rounded-4">
            ...
            <div class="card-body d-sm-flex justify-content-between shadow bg-light rounded-4">
              ...
              <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
                <span style="color: #E0A100;">PERSONNEL ACCOUNT</span>
              </h4>
              <!-- 
      ...
      <div class="col-md-12 headertop ms-0">
        <div class="container-fluid">
          ...
          <a href="#" data-bs-toggle="modal" data-bs-target="#modalRegisterForm"><button type="button" class="btn btn-success waves-effect waves-light rounded-4"><svg class="" width="20" height="20">
                <use xlink:href="#userPlus" />
              </svg> Add Personnel Account</button></a>
          <hr>
        </div>
      </div>
          ...
          <div class="table-responsive">
            <table id="dtable" class="table table-striped w-100">
              ...
              <tbody>
                ...
                $query = "SELECT * FROM personnel_login";
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td width='8%'><a href="edit_user.php?id=<?php echo $id; ?>">
                        <svg class="" width="20" height="20">
                          <use xlink:href="#edit" />
                        </svg></a> | <a href="delete_user.php?id=<?php echo htmlentities($rs['id']); ?>" onclick="yesNO(event)"><svg class="" width="20" height="20" style="color:red; cursor: hand;">
  ...
  <div class="modal fade" id="modalRegisterForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <form action="create_personnel.php" method="POST" id="form">
      <div class="modal-dialog modal-dialog-centered rounded-5" role="document">
        <div class="modal-content bg-light rounded-5">
          <div class="modal-header text-center rounded-5">
            <h4 class="modal-title w-100 rounded-4" style="color: green;"> ADD PERSONNEL ACCOUNT</h4>
          ...
          <div class="modal-body rounded-4">
            ...
            <div class="form-floating mb-3">
              <input type="text" class="form-control rounded-4" id="email" placeholder="Enter email" name="email_address">
              <label for="email"><svg class="" width="20" height="20">
            ...
            <div class="form-floating mb-3">
              <input type="password" class="form-control rounded-4" id="pass" placeholder="Enter password" name="user_password" required>
              <label for="email"><svg class="" width="20" height="20">
                  <use xlink:href="#lock" />
            ...
            <div class="col md-6 form-floating mb-3">
                <select class="form-select rounded-4" aria-label="Default select example" required name="user_status"
                  ...
                  <option value="Faculty" selected > Personnel</option>
                </select>
                <label class="ms-2 mb-1"><svg class="" width="20" height="20">
                    <use xlink:href="#users" />
                  </svg> Admin/HR/Personnel</label>
              </div>
            ...
            <div class="form-floating mb-3">
              <span class="custom-file-input">
                <label for="signature" class="form-label me-2 fw-bold">SIGNATURE:</label>
                <input type="file" class="form-control fw-bold rounded-3" id="signature" name="signatureFiles[]" accept=".png, .jpeg, .jpg" multiple required>
              </span>
              <p class="mt-2"><strong>NOTE:</strong> Signature should be on PNG and JPEG only!</p>
            </div>
            <div class="modal-footer d-flex justify-content-center">
              <button class="btn btn-warning fw-bold rounded-4">CREATE ACCOUNT </button>
            </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener('submit', function(event) {
        if (fileInput.files.length !== maxFiles) {
            ...
            alert('You must upload exactly 7 files.');
        }
    });
});
</script>
...
<script>
      function userType(value) {
          ...
          if (val === "Faculty") {
            ...
            document.getElementById("form").action = "create_personnel.php";
          } else if (val === "HR") {
            document.getElementById("email").name = "hr_email";
            document.getElementById("pass").name = "hr_password";
            document.getElementById("form").action = "create_hr.php";
          } else {
