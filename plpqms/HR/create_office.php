...
<head>
  ...
  <title>PLP | QMS Department Office</title>
  ...
  <div class="row d-md-block w-100 ms-0">
    <div class="d-flex flex-column flex-shrink-0 p-3 pt-4 float-start" style="background-color: green;" id="sidebar">
      ...
      <li>
        ...
        <li>
          <a href="add_offices.php" class="nav-link text-white" style="background-color: rgba(202, 202, 202, .65);"">
          <svg class=" bi pe-none me-2" width="16" height="16">
            <use xlink:href="#building" /></svg>
            Department Offices
          </a>
        </li>
        <li>
...
-->
    ...
    <div class="row ms-0 w-100" style="position: relative;">
          ...
          <div class="card mb-4 wow fadeIn rounded-4">
            ...
            <div class="card-body d-sm-flex justify-content-between shadow bg-light rounded-4">
              ...
              <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
                <span style="color: #E0A100;">DEPARTMENT OFFICE</span>
              </h4>
              <!-- 
      ...
      <div class="col-md-12 headertop ms-0">
        <div class="container-fluid">
          ...
          <a href="#" data-bs-toggle="modal" data-bs-target="#addOffice"><button type="button" class="btn btn-success waves-effect waves-light rounded-4"><svg class="bi pe-none me-2" width="12" height="16">
                <use xlink:href="#building" />
              </svg> Add Department Offices</button></a>
          <hr>
        </div>
      </div>
      <div class="col-md-12">
          ...
          <div class="table-responsive">
            <table id="dtable" class="table table-striped w-100">
              ...
              <tbody>
                ...
                $query = "SELECT DISTINCT ID,OFFICES, OFNAME FROM department_office";
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td width="30%"><?php echo  $ofname; ?></td>
                    ...
                    <td>
                      ...
                      <a href="#" class="btn btn-sm btn-outline-yellow editButton" data-bs-toggle="modal" data-bs-target="#editOffice" data-id="<?php echo $id; ?>" data-offices="<?php echo $offices; ?>" data-ofname="<?php echo $ofname; ?>">
                      ...
                      document.addEventListener('DOMContentLoaded', (event) => {
                        ...
                        editButtons.forEach(button => {
                          button.addEventListener('click', () => {
                            ...
                            const offices = button.getAttribute('data-offices');
                            const ofname = button.getAttribute('data-ofname');

                            document.querySelector('#editOffice #name').value = offices;
                            document.querySelector('#editOffice #ofname').value = ofname;
                            document.querySelector('#editOffice form').action = `create_office.php?id=${id}`;
                          });
                        });
                      });
                    </script>
    ...
    <div class="footerstyleAccount">
      <div class="col-md-12 headertop ms-0 position-relative bottom-0 start-0">
        <footer class="ms-0 w-100 py-3 mb-5 border-top border-5 border-warning mt-4" style="background-color: green;" id="footerSize">
          <center>
            <p class="text-light my-0" id="footerText"> COPYRIGHT PAMANTASAN NG LUNSGOD NG PASIG ALL RIGHT RESERVED &copy; 2023</p>
          </center>
        </footer>
      </div>
    </div>
  ...
  <div class="modal fade" id="addOffice" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">

    <form action="create_office.php" method="POST" id="form">
      <div class="modal-dialog modal-dialog-centered rounded-5" role="document">
        <div class="modal-content bg-light rounded-5">
          <div class="modal-header text-center rounded-5">
            <h4 class="modal-title w-100 font-weight-bold" style="color: green;"><svg class="" width="32" height="32">
                <use xlink:href="#building" />
              </svg> ADD DEPARTMENT OFFICES</h4>
            <button type="button" class="btn-close" data-bs-dismiss="modal">
            </button>
          </div>
          <div class="modal-body">
            ...
            <div class="form-floating mb-3">
              ...
              <label for="email"><svg class="" width="20" height="20">
                  <use xlink:href="#building" />
                </svg> Department Offices</label>
            </div>
            <div class="form-floating mb-3">
              <input type="text" class="form-control rounded-4" id="name" placeholder="Enter Department Office Name" name="ofname">
              <label for="email"><svg class="" width="20" height="20">
                  <use xlink:href="#building" />
                </svg> Department Offices Name </label>
            </div>
  ...
  <div class="modal fade" id="editOffice" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="create_office.php?id=<?php echo $id;?>" method="POST" id="form">
      <div class="modal-dialog modal-dialog-centered rounded-5" role="document">
        <div class="modal-content bg-light rounded-5">
          <div class="modal-header text-center rounded-5">
            <h4 class="modal-title w-100 font-weight-bold" style="color: green;">
              <svg class="" width="32" height="32">
                <use xlink:href="#building" />
              </svg> EDIT DEPARTMENT OFFICES
            </h4>
            <button type="button" class="btn-close" data-bs-dismiss="modal">
            </button>
          </div>
          <div class="modal-body">
            ...
            <div class="form-floating mb-3">
              <input type="text" class="form-control rounded-4" id="name" placeholder="Enter Department Office" name="nameOffice">
              <label for="name"><svg class="" width="20" height="20">
                  <use xlink:href="#building" />
                </svg> Department Offices</label>
            </div>
            <div class="form-floating mb-3">
              <input type="text" class="form-control rounded-4" id="ofname" placeholder="Enter Department Office Name" name="ofname">
              <label for="ofname"><svg class="" width="20" height="20">
                  <use xlink:href="#building" />
                </svg> Department Offices Name </label>
            </div>

            <div class="modal-footer d-flex justify-content-center" id="reg">
              <button class="btn btn-warning fw-bold rounded-4" name="upp">UPDATE DEPARTMENT OFFICE</button>
            </div>
          </div>
        </div>
      </div>
...
if (isset($_POST['reg'])) {
  ...
  text:'The Inputted Department Offices is Already Created!!',
  confirmButtonColor:'#00396D',
   ...
   timer:3000
    ...
    $conn->query("INSERT INTO `department_office` VALUES('0','$offices','$ofname')") or die(mysqli_error($conn));
    echo "<script type='text/javascript'>
document.querySelector('body').style.overflow = 'hidden';
Swal.fire({
  icon: 'success',
...
} else if (isset($_POST['upp'])) {
  $office_id = $_GET['id'];
  $offices = mysqli_real_escape_string($conn, $_POST['nameOffice']);
  $ofname = mysqli_real_escape_string($conn, $_POST['ofname']);

  $conn->query("UPDATE `department_office` SET offices = '$offices', OFNAME = '$ofname' WHERE ID = '$office_id'") or die(mysqli_error($conn));
  echo "<script type='text/javascript'>
  document.querySelector('body').style.overflow = 'hidden';
  Swal.fire({
    icon: 'success',
    title: 'Offices Succesfully Edited!!',
    text:'The Creation of Department Offices Has Been Succesfully Edited!!',
    confirmButtonColor:'#00396D',
     confirmButtonText: 'Okay',
     timer:3000
  }).then(function(){
