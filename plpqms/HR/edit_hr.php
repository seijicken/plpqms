...
<!-- for Sidebar Design -->
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
      ...
      <li>
        <a href="dashboard.php" class="nav-link" style="color: #fff;">
  ...
  <div class="dark p-4">
    ...
    <!-- <li>
      ...
      <li>
        ...
        <a href="view_acc.php" class="nav-link dropdown-item text-white" style="background-color: rgba(202, 202, 202, .65);">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#folder"/></svg>
           - Admins Accounts
        </a></li>
        <li>
...
<div class="container-fluid">
    ...
    <a href="#" data-bs-toggle="modal" data-bs-target="#modalRegisterForm"><button type="button" class="btn btn-success waves-effect waves-light rounded-4"><svg class="" width="20" height="20"><use xlink:href="#userPlus"/></svg>   Add HR Account</button></a>
    <hr>
    </div>
  </div>
          ...
          ?>       
           ...
           <tr>
              <td width='5%' class="fw-bold"><?php echo $idname; ?></td>
               ...
               <td width='20%'><?php echo $rs['hr_email']; ?></td>
              
               <td width='20%'><?php echo $rs['hr_password']; ?></td>
               <td width='8%'><a href="edit_hr.php?id=<?php echo $rs['id'];?>"><svg class="" href="edit_hr.php" width="20" height="20"><use xlink:href="#edit"/></svg></a> | <a href="delete_admin.php?id=<?php echo htmlentities($rs['id']); ?>" onclick="yesNO(event)"><svg class="" width="20" height="20" style="color:red; cursor: hand;"><use xlink:href="#trash"/></svg>
 <script>
              function yesNO(ev){
...
$q = mysqli_query($conn,"SELECT * FROM `hr_user` WHERE id = '$idname'") or die (mysqli_error($conn));
 ...
 $rs1 = mysqli_fetch_array($q);
               ...
               $fname1=$rs1['name'];
               $admin1=$rs1['hr_email'];
               $pass1=$rs1['hr_password'];
               $status=$rs1['hr_status'];
             
?>
  <div class="modal-dialog rounded-5" role="document">
    <form method="POST" action="editHrProcess.php">
    <div class="modal-content rounded-5">
      <div class="modal-header text-center rounded-5">
        <h4 class="modal-title w-100 font-weight-bold rounded-4"><svg class="" width="32" height="32"><use xlink:href="#edit"/></svg> EDIT HR ACCOUNT</h4>
        ...
        <div class="form-floating mb-3">
          <input type="email" id="orangeForm-email" placeholder="Enter New Email" name="hr_email" value="<?php echo $admin1;?>" class="form-control validate rounded-4">
          <label for="email"><svg class="" width="20" height="20"><use xlink:href="#email"/></svg>    Update Email</label>
        </div>
        <div class="form-floating mb-3">
          <input type="password" id="orangeForm-pass" placeholder="Ente" name="hr_password" value="<?php echo $pass1;?>" class="form-control validate rounded-4">
          <label for="email"><svg class="" width="20" height="20"><use xlink:href="#lock"/></svg>   Update Password</label>
        </div>
          <div class="form-floating mb-3">
          <input type="text" id="orangeForm-pass" name="hr_status" placeholder="Current Status" value = "<?php echo $status;?>" class="form-control validate rounded-4" readonly="">
  ...
  <div class="modal-dialog modal-dialog-centered rounded-5" role="document">
    <div class="modal-content bg-light rounded-5">
      <div class="modal-header text-center rounded-5">
        <h4 class="modal-title w-100 rounded-4" style="color: green;"> ADD HR ACCOUNT</h4>
    ...
    <div class="form-floating mb-3">
        <input type="text" class="form-control rounded-4" id="email" placeholder="Enter email" name="hr_email">
        <label for="email"><svg class="" width="20" height="20"><use xlink:href="#email"/></svg>   Enter Email</label>
    </div>

      <div class="form-floating mb-3">
        <input type="password" class="form-control rounded-4" id="pass" placeholder="Enter password" name="hr_password" required>
    ...
    <div class="row">
        ...
        <select class="form-select rounded-4" aria-label="Default select example" required name="hr_status" onchange="userType(this.value);">
