...
<body>
      ...
      <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
        ...
        <li>
          ...
          <ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3" style="background-color: green;">
            <li>
            <li>
              <a href="baseline.php" class="nav-link dropdown-item text-white">
                <svg class="bi pe-none me-2" width="16" height="16">
                  <use xlink:href="#lock" />
                </svg>
                - Baseline Files
          ...
          <div class="card mb-4 wow fadeIn rounded-4">
            ...
            <div class="card-body d-sm-flex justify-content-between shadow bg-light rounded-4">
              ...
              <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
                <a href="dashboard.php" style="text-decoration: none; color:green; ">HOME PAGE</a>
                <span>|</span>
      ...
      <div class="col-md-12 headertop ms-0">
        <div class="container-fluid">
          ...
          <a href="#" data-bs-toggle="modal" data-bs-target="#addOffice"><button type="button" class="btn btn-success waves-effect waves-light rounded-4"><svg class="bi pe-none me-2" width="12" height="16">
              ...
              </svg>Department Offices</button></a>

          <hr>
        </div>
        <div class="container-fluid">
          <!--   <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalRegisterForm">Add File</button> -->
          <a href="#" data-bs-toggle="modal" data-bs-target="#editOffice"><button type="button" class="btn btn-success waves-effect waves-light rounded-4"><svg class="bi pe-none me-2" width="12" height="16">
                <use xlink:href="#building" />
              </svg>Department Offices</button></a>
          ...
          <div class="table-responsive">
            <table id="dtable" class="table table-striped w-100">
              ...
              <tbody>
                ...
                $query = "SELECT DISTINCT ID,OFFICES, OFNAME FROM department_office ORDER by OFFICES DESC";
        ...
        <div class="modal-content bg-light rounded-5">
          ...
          <div class="modal-body">
            ...
            <div class="form-floating mb-3">
              ...
              <input type="text" class="form-control rounded-4" id="name" placeholder="Enter Department Office" name="ofname">
              <label for="email"><svg class="" width="20" height="20">
                  <use xlink:href="#building" />
                </svg> Department Offices</label>
            </div>
  ...
  <form action="update_office" method="POST" id="form">
    <div class="modal-dialog modal-dialog-centered rounded-5" role="document">
      <div class="modal-content bg-light rounded-5">
        <div class="modal-header text-center rounded-5">
...
if (isset($_POST['reg'])) {
  ...
  $conn->query("UPDATE `department_office` SET offices = '$offices', OFNAME = '$ofname' WHERE ID = '$id'") or die(mysqli_error($conn));
    echo "<script type='text/javascript'>
document.querySelector('body').style.overflow = 'hidden';
Swal.fire({
  icon: 'success',
