...
<div class="row d-md-block w-100 ms-0">
    ...
    <ul class="dropdown-menu dropdown-menu-dark text-small shadow" id="logout">
        <li><a class="dropdown-item" href="#" onclick="confirmSignOut()">Sign out <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#signout"/></svg></a>
          ...
          ?>       
           ...
           <tr>
              <td width='5%' class="fw-bold"><?php echo $idname; ?></td>
               ...
               <td width='20%'><?php echo $rs['email_address']; ?></td>
               <td width='20%'><?php echo $rs['designation']; ?></td>
               <td width='20%'><?php echo $rs['user_password']; ?></td>
               <td width='8%'><a href="edit_user.php?id=<?php echo $rs['id'];?>"><svg class="" href="edit_user.php" width="20" height="20"><use xlink:href="#edit"/></svg></a> | <a href="delete_admin.php?id=<?php echo htmlentities($rs['id']); ?>" onclick="yesNO(event)"><svg class="" width="20" height="20" style="color:red; cursor: hand;"><use xlink:href="#trash"/></svg>
 <script>
              function yesNO(ev){
  ...
  <div class="modal-dialog rounded-5" role="document">
    ...
    <div class="modal-content rounded-5">
      <div class="modal-header text-center rounded-5">
        <h4 class="modal-title w-100 font-weight-bold rounded-4"><svg class="" width="32" height="32"><use xlink:href="#edit"/></svg> EDIT FACULTY ACCOUNT</h4>
        ...
        <div class="form-floating mb-3">
          ...
          <div class="form-floating mb-3">
          <input type="text" id="orangeForm-pass" name="user_status" placeholder="Current Status" value = "<?php echo $status;?>" class="form-control validate rounded-4" readonly="">
