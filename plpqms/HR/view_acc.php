...
<head>
  ...
  <title>PLP | QMS View Admin Account</title>
...
<body>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol id="edit"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024"
        height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h274.9c-2.4-6.8-3.4-14-2.6-21.3l6.8-60.9 1.2-11.1 7.9-7.9 77.3-77.3c-24.5-27.7-60-45.5-99.9-45.5zm45.3 145.3l-6.8 61c-1.1 10.2 7.5 18.8 17.6 17.6l60.9-6.8 137.9-137.9-71.7-71.7-137.9 137.8zM633 268.9L595.1 231c-9.3-9.3-24.5-9.3-33.8 0l-37.8 37.8-4.1 4.1 71.8 71.7 41.8-41.8c9.3-9.4 9.3-24.5 0-33.9z" />
      </svg></symbol>
    <symbol id="trash"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024"
        height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
        ...
        <li>
          ...
          <ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3"
            ...
            <li>
              <a href="view_faculty.php" class="nav-link dropdown-item text-white">
                <svg class="bi pe-none me-2" width="16" height="16">
                  <use xlink:href="#history" />
                </svg>
...
-->
        ...
        <li>
          ...
          <ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3"
            ...
            <li>
              <a href="view_hr.php.php" class="nav-link dropdown-item text-white">
                <svg class="bi pe-none me-2" width="16" height="16">
                  <use xlink:href="#folder" />
                </svg>
                - HR Accounts
  ...
  <div class="content">
    ...
    <div class="container-fluid">
      <a href="#" data-bs-toggle="modal" data-bs-target="#privacyPolicyModal">
        <button type="button" class="btn btn-success waves-effect waves-light rounded-4">
          <svg class="" width="20" height="20">
            <use xlink:href="#userPlus" />
          </svg> Add Admin Account
        </button>
      </a>
      <hr>
    </div>
...
<div class="modal fade" id="privacyPolicyModal" tabindex="-1" aria-labelledby="privacyPolicyModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" id="privacyPolicyContent">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-secondary" id="privacyCloseBtn">Close</button>
        <button type="button" class="btn btn-primary" id="privacyProceedBtn" disabled>Proceed</button>
      </div>
    </div>
  </div>
</div>
          ...
          <div class="table-responsive">
            <table id="dtable" class="table table-striped w-100">
              ...
              <thead>
                ...
                <th class="desktop">Action</th><!-- admin account -->
              </thead>
              <tbody>
                <?php
                require_once ("connection.php");

                $query = "SELECT * FROM admin_login WHERE admin_status = 'Admin'";
                ...
                while ($rs = mysqli_fetch_assoc($result)) {
                  ...
                  <tr>
                    ...
                    <td width='8%'><a href="tryEdit.php?id=<?php echo $rs['id']; ?>"><svg class="" href="tryEdit.php"
                          width="20" height="20">
                          <use xlink:href="#edit" />
                        </svg></a> | <a href="delete_admin.php?id=<?php echo htmlentities($rs['id']); ?>"
                        onclick="yesNO(event)"><svg class="" width="20" height="20" style="color:red; cursor: hand;">
      ...
      <div class="modal-dialog modal-dialog-centered rounded-5" role="document">
        <div class="modal-content bg-light rounded-5">
          <div class="modal-header text-center rounded-5">
            <h4 class="modal-title w-100 rounded-4" style="color: green;"> ADD ADMIN ACCOUNT</h4>
          ...
          <div class="modal-body rounded-4">
            ...
            <div class="form-floating mb-4">
              <span class="custom-file-input">
                <label for="signature" class="form-label me-2 fw-bold">UPLOAD 7 SIGNATURE:</label>
              ...
              <p class="mt-2"><strong>NOTE:</strong> Signatures should be in PNG or JPEG format only!</p>
            </div>

            <div class="modal-footer d-flex justify-content-center" id="reg">
              <button class="btn btn-warning fw-bold rounded-4" name="reg">CREATE ACCOUNT</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <script>
      function userType(value) {
        ...
        if (val === "Faculty") {
          ...
          document.getElementById("email").name = "hr_address";
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const registrationModal = new bootstrap.Modal(document.getElementById('modalRegisterForm'));
        ...
        // Toggle Proceed button enabled/disabled based on checkbox state
        privacyPolicyCheckbox.addEventListener('change', function() {
            privacyProceedBtn.disabled = !privacyPolicyCheckbox.checked;
        });

        // Handle "Close" button click
        privacyCloseBtn.addEventListener('click', function() {
            privacyPolicyModal.hide(); // Hide the privacy policy modal
        });
        ...
        privacyProceedBtn.addEventListener('click', function() {
            if (privacyPolicyCheckbox.checked) {
                privacyPolicyModal.hide(); // Hide the privacy policy modal
                registrationModal.show(); // Show the registration modal
            } else {
                alert('Please acknowledge the privacy policy before proceeding.');
            }
        });

        // Load privacy policy content
        privacyPolicyModalElement.addEventListener('show.bs.modal', function() {
            fetch('privacy_policy.html')
                .then(response => response.text())
                .then(data => {
                    document.getElementById('privacyPolicyContent').innerHTML = data;
                })
                .catch(error => console.error('Error loading privacy policy:', error));
        });

        // Optionally, if you want to ensure the privacy policy modal is closed when registration modal is shown
        registrationModal._element.addEventListener('show.bs.modal', function() {
            privacyPolicyModal.hide(); // Hide the privacy policy modal if it is open
        });
    });
</script>
