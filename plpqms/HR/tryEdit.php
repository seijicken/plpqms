...
<div class="container-fluid">
    ...
    <a href="#" data-bs-toggle="modal" data-bs-target="#modalRegisterForm"><button type="button" class="btn btn-success waves-effect waves-light rounded-4"><svg class="" width="20" height="20"><use xlink:href="#userPlus"/></svg>   Add Admin Account</button></a>
    <hr>
    </div>
  </div>
     ...
     <?php
         ...
         ?>
           ...
           <tr>
             ...
             <td width='8%'><a href="tryEdit.php?id=<?php echo $rs['id']; ?>"><svg class="" href="tryEdit.php" width="20" height="20">
                   <use xlink:href="#edit" />
                 </svg></a> | <a href="delete_admin.php?id=<?php echo htmlentities($rs['id']); ?>" onclick="yesNO(event)"><svg class="" width="20" height="20" style="color:red; cursor: hand;">
