...
<head>
  ...
  <style>
    ...
    .color-picker-wrapper label {
      ...
      white-space: nowrap;
      /* Prevent line break within the label */
    }

    .color-picker-wrapper input[type="color"] {
      flex-shrink: 0;
      /* Prevent the input from shrinking */
      width: 60%;
...
<body>
  ...
  <div class="row d-md-block w-100 ms-0">
    <div class="d-flex flex-column flex-shrink-0 p-3 pt-4 float-start" style="background-color: green;  color: pink;"
      id="sidebar">

      <a href="home.php" class="logo-wrapper">
        <img class="img-fluid mt-0" src="../assets/img/PLPLOGO2.png" width="250px" height="250px" id="Logo"></img>
      </a>
      <hr class="text-warning" style="background-color: orange;">
      <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
        <li class="nav-item">
          <a href="home.php" class="nav-link text-white" id="text" aria-current="page">
      ...
      <li>
        ...
        <li>
          <a href="settings.php" class="nav-link text-white" style="background-color: rgba(202, 202, 202, .65);">
...
-->
  ...
  <div class="content mx">
    <div class="row ms-0 w-100" style="position: relative;">
          ...
          <div class="card mb-4 wow fadeIn rounded-4">
            ...
            <div class="card-body d-sm-flex justify-content-between shadow bg-light rounded-4">
              ...
              <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
                <span style="color: #E0A100;">SETTINGS</span>
              </h4>
              <!-- 
      ...
      <div class="card mb-4 wow fadeIn mx-auto">
        <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">SYSTEM DESIGN</h4>
        <form>
          <div class="form-row align-items-center mb-4">
            <div class="col-auto">
              <label for="systemTitle">Title</label>
              <input type="text" class="form-control mb-2" id="systemTitle">
            </div>
            <div class="col-auto">
              <label for="logoUpload">Logo</label>
              <input type="file" class="form-control-file mb-2" id="logoUpload" accept="image/*">
            </div>
            <div class="col-auto">
              <label for="documentTemplate">Document Template</label>
              <input type="file" class="form-control-file mb-2" id="documentTemplate">
            </div>
          </div>
          <div class="form-row align-items-center mb-4">
            <div class="form-section">
              <h5>Header Colors</h5>
              <div class="col-auto color-picker-wrapper">
                <label for="headerBgColor">Background</label>
                <input type="color" id="headerBgColors" value="#ffffff">
              </div>
              <div class="col-auto color-picker-wrapper">
                <label for="headerTextColor">Text</label>
                <input type="color" id="header-text-colors" value="#ffffff">
              </div>
            </div>
            <div class="form-section">
              <h5>Sidebar Colors</h5>
              <div class="col-auto color-picker-wrapper">
                <label for="sidebarBgColor">Background</label>
                <input type="color" id="sidebarBgColor" value="#ffffff">
              </div>
              <div class="col-auto color-picker-wrapper">
                <label for="sidebarTextColor">Text</label>
                <input type="color" id="sidebar-text-colors" value="#ffffff">
              </div>
            </div>
            <div class="form-section">
              <div class="email-domain-wrapper col-auto">
                <label for="emailDomain">Email Domain</label>
                <input type="text" class="form-control" id="emailDomain" placeholder="@plpasig.edu.ph">
              </div>
            </div>
          </div>
      ...
      <div class="form-row align-items-center mb-4 mx-auto">
        <div class="col-auto">
          ...
          <input type="text" class="form-control mb-2" id="debug">
        </div>
        <div class="col-auto">
          <label for="file_expired_action">File Expired Action</label>
          <input type="text" class="form-control mb-2" id="file_expired_action">
        </div>
        <div class="col-auto">
          <label for="demo">Demo</label>
          <input type="text" class="form-control mb-2" id="demo">
        </div>
        <div class="col-auto">
          <label for="authorization">Authorization</label>
          <input type="text" class="form-control mb-2" id="authorization">
        </div>
        <div class="col-auto">
          <label for="authen">Authen</label>
          <input type="text" class="form-control mb-2" id="authen">
        </div>
        <div class="col-auto">
          <label for="allow_signup">Allow Signup</label>
          <input type="text" class="form-control mb-2" id="allow_signup">
        </div>
        <div class="col-auto">
          <label for="site_mail">Site Mail</label>
          <input type="text" class="form-control mb-2" id="site_mail">
        </div>
        <div class="col-auto">
          <label for="allow_password_reset">Allow Password Reset</label>
          <input type="text" class="form-control mb-2" id="allow_password_reset">
        </div>
        <div class="col-auto">
          <label for="root_id">Root ID</label>
          <input type="text" class="form-control mb-2" id="root_id">
        </div>
        <div class="col-auto">
          <label for="try_nis">Try NIS</label>
          <input type="text" class="form-control mb-2" id="try_nis">
        </div>
        <div class="col-auto">
          <label for="dataDir">Data Directory</label>
          <input type="text" class="form-control mb-2" id="dataDir">
        </div>
        <div class="col-auto">
          <label for="language">Language</label>
          <input type="text" class="form-control mb-2" id="language">
        </div>
        <div class="col-auto">
          <label for="max_filesize">Max File Size</label>
          <input type="text" class="form-control mb-2" id="max_filesize">
        </div>
        <div class="col-auto">
          <label for="max_query">Max Query</label>
          <input type="text" class="form-control mb-2" id="max_query">
        </div>
        <div class="col-auto">
          <label for="revision_expiration">Revision Expiration</label>
          <input type="text" class="form-control mb-2" id="revision_expiration">
        </div>
      </div>
      <div class="col-lg-3 mx-auto">
        <div class="d-flex justify-content-between mb-3">
          <button type="button" class="btn btn-success w-25" style="background-color: #1AB056;" id="saveColors"
            onclick="OnSaveClick()">Save</button>
          <button type="button" class="btn btn-secondary w-25" id="cancelColors">Cancel</button>
        </div>
      </div>
      </form>
    </div>
    ...
    <div class="footerstyleAccount">
      <div class="col-md-13 headertop ms-0 position-relative bottom-0 start-0">
  ...
  <script>
    ...
    function onSaveClick() {
      ...
      const headerBgColorPicker = document.getElementById('headerBgColors');
      const sidebarText = document.getElementById('text');
      const sidebarTextColorPicker = document.getElementById('sidebar-text-colors');
      const sidebar = document.getElementById('sidebar');
      const sidebarBgColorPicker = document.getElementById('sidebarBgColor');

      // Initial colors
      let initialHeaderBgColor = headerBgColorPicker.value;
      let initialSidebarBgColor = sidebarBgColorPicker.value;
      let initialSidebarTextColor = sidebarTextColorPicker.value;

      // Event listener for color pickers
      sidebarBgColorPicker.addEventListener('input', function (event) {
        sidebar.style.backgroundColor = event.target.value;
      });

      headerBgColorPicker.addEventListener('input', function (event) {
        header.style.backgroundColor = event.target.value;
      });

      sidebarTextColorPicker.addEventListener('input', function (event) {
        sidebarText.style.color = event.target.value;
      });
      ...
      LogoUpload.addEventListener('change', function (event) {
        ...
        if (file) {
          ...
          reader.onload = function () {
            // Set the logo source to the uploaded image
            Logo.src = reader.result;
            Logo.alt = 'New Company Logo'; // Update the alt text for accessibility
          };
      ...
      document.getElementById('saveColors').addEventListener('click', function () {
        // Update initial colors with the current ones
        initialHeaderBgColor = headerBgColorPicker.value;
        initialSidebarBgColor = sidebarBgColorPicker.value;
        initialSidebarTextColor = sidebarTextColorPicker.value;
        alert('Colors saved successfully!');
      });

      // Event listener for Cancel button
      document.getElementById('cancelColors').addEventListener('click', function () {
        headerBgColorPicker.value = initialHeaderBgColor;
        sidebarBgColorPicker.value = initialSidebarBgColor;
        sidebarTextColorPicker.value = initialSidebarTextColor;
        header.style.backgroundColor = initialHeaderBgColor;
        sidebar.style.backgroundColor = initialSidebarBgColor;
        sidebarText.style.color = initialSidebarTextColor;
      });
    }

    document.addEventListener("DOMContentLoaded", function () {
      onSaveClick(); // Call the function when the DOM is ready
    });
      ...
      <div class="modal-dialog modal-dialog-centered rounded-5" role="document">
        <div class="modal-content bg-light rounded-5">
          ...
          <div class="modal-body">
            ...
            <div class="form-floating mb-3">
              <input type="text" class="form-control rounded-4" id="name" placeholder="Enter Department Office"
                name="nameOffice">
              <label for="email"><svg class="" width="20" height="20">
                  <use xlink:href="#building" />
            ...
            <div class="form-floating mb-3">
              <input type="text" class="form-control rounded-4" id="name" placeholder="Enter Department Office Name"
                name="ofname">
              <label for="email"><svg class="" width="20" height="20">
                  <use xlink:href="#building" />
  ...
  <!-- Script for Settings -->
  <script>
    function pickColor(elementId) {
      let colorPicker = document.createElement('input');
      colorPicker.type = 'color';
      colorPicker.style.display = 'none';
      colorPicker.addEventListener('input', function () {
        document.getElementById(elementId).style.backgroundColor = colorPicker.value;
      });
    ...
    $(document).ready(function () {
      $("#myForm").submit(function (e) {
        ...
        let data = {
          ...
          "expiration-time": $("#expiration-time").val(),
          "revision-expiration": $("#revision-expiration").val(),
          "logo": $("#logo").val(),
          "sidebar-colors": $("#sidebar-colors").val(),
          "background": $("#background").val(),
          "text": $("#text").val(),
          "document-template": $("#document-template").val(),
          "upload-template": $("#upload-template").val(),
          "email-domain": $("#email-domain").val(),
          "file-expired-action": $("#file-expired-action").val(),
          "authorization": $("#authorization").val(),
          "allow-signup": $("#allow-signup").is(":checked"),
          "allow-password-reset": $("#allow-password-reset").is(":checked"),
          "try-nis": $("#try-nis").val(),
          "language": $("#language").val(),
          "max-quey": $("#max-quey").val()
        };
        $.ajax({
          type: "POST",
