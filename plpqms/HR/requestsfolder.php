...
<html lang="en">
  <head>
    ...
    <title>PLP | QMS Manage All Requests</title>
...
<div class="row d-md-block w-100 ms-0">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1"id="itemSidebar">
      ...
      <li>
        ...
        <a href="requestsfolder.php" class="nav-link dropdown-item text-white" style="background-color: rgba(202, 202, 202, .65);">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#folder"/></svg>
           - All Request
        </a></li>
        <li>
               ...
               const swalWithBootstrapButtons = Swal.mixin({
                ...
                swalWithBootstrapButtons.fire({
                  ...
                  if (result.isConfirmed) {
                    ...
                    swalWithBootstrapButtons.fire(
                      'Cancelled!',
                      'Your File is Safe and Didnt Got Deleted.',
                      'error'
                    )
