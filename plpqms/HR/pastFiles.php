...
<head>
  ...
  <title>PLP | QMS Manage All Files</title>
...
<body>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol id="left"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol id="right"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="row d-md-block w-100 ms-0">
    <div class="d-flex flex-column flex-shrink-0 p-3 pt-4 float-start" style="background-color: green;" id="sidebar">
      ...
      <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
        ...
        <li>
          <a href="pastFiles.php" class="nav-link text-white" style="background-color: rgba(202, 202, 202, .65);">
            <svg class=" bi pe-none me-2" width="16" height="16">
  ...
  <div class="content">
    <div class="row ms-0 w-100" style="position: relative;">
          ...
          <div class="card mb-4 wow fadeIn rounded-4 ">
            ...
            <div class="card-body d-sm-flex justify-content-between shadow bg-light rounded-4 ">
              ...
              <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4 ">
                <span style="color: #E0A100;">MANAGE ALL FILES</span>
              </h4>
              <!-- 
      ...
      // Check if the department was submitted
      if (isset($_POST['department'])) {
        $department = $conn->real_escape_string($_POST['department']);
      }

      // Check if the actions was submitted
      if (isset($_POST['actions'])) {
        $actions = $conn->real_escape_string($_POST['actions']);
      }

      // Construct the SQL query
      $query100 = "SELECT * FROM upload_files WHERE ARCHIVE = '0' AND  1=1";

      if ($department != 'all') {
        $query100 .= " AND DEPARTMENT = '$department'";
      }

      if ($actions != 'all') {
        $query100 .= " AND file_status = '$actions'";
      } else {
        $query100 .= " AND file_status IN ('Approved', 'Rejected')";
      }
      ...
      <div class="col-md-12 headertop ms-0">
        <div class="container-fluid">
          ...
          <div class="d-flex">
            <form class="d-flex" action="pastFiles.php" id="manageFiles" method="POST">
              <div class="form-group me-2">
                <select class="d-inline-block form-select fw-bold btn waves-effect waves-light pe-5 rounded-4 " onchange="folder();" name="department" aria-label="Default select example" style="background-color: #E0A100;"><i class="fas fa-file-medical">
                    <option value="" selected disabled>Choose Department</option>
                    <option value="all" <?php if ($department == 'all') echo 'selected'; ?>>All Department</option>
                    <?php
                    require_once("connection.php");
                    ...
                    ?>
                      <option value="<?php echo $offices; ?>" <?php if ($department == $offices) echo 'selected'; ?>><?php echo $offices; ?></option> <?php } ?>

                  </i></select></input>
              </div>
              <div class="form-group">
                <select class="d-inline-block form-select fw-bold btn waves-effect waves-light pe-5 rounded-4 " onchange="folder();" name="actions" aria-label="Default select example" style="background-color: #E0A100;"><i class="fas fa-file-medical">
                    <option value="" selected disabled>Choose Actions</option>
                    <option value="all" <?php if ($actions == 'all') echo 'selected'; ?>>All</option>
                    <option value="Approved" <?php if ($actions == 'Approved') echo 'selected'; ?>>Approved</option>
                    <option value="Rejected" <?php if ($actions == 'Rejected') echo 'selected'; ?>>Rejected</option>
                  </i></select></input>
              </div>
            </form>
              ...
              <div class="input-group">
                <span class="input-group-btn">
                  <a href="ceatfolder.php" class="text-black">
                    <button class="d-inline-block fw-bold btn waves-effect waves-light rounded-4 " style="background-color: #E0A100;">
                      Old Documents
                      <svg class="" width="20" height="20">
          ...
          <div class="table-responsive">
            <table id="dtable" class="table table-striped w-100">
              ...
              <tbody>
                <?php
                if ($result100) {
                  while ($file = mysqli_fetch_array($result100)) {
                    $id = $file['id'];
                ...
                ?>
                    <tr>
                      ...
                      <td width="3%" class="fw-bold"><?= $file_status ?></td>
                      ...
                      <td width="10%">
                        ...
                        <a href="downloads.php?file_id=<?php echo $id; ?>" onclick="downloadYes(event)" class="btn btn-sm btn-outline-success"><i class="fa fa-download"></i>
                          <script>
  ...
  <div class="modal fade" id="modalRegisterForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script>
      function folder() {
        document.getElementById('manageFiles').submit();
      }
    </script>
