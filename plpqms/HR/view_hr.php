...
-->
    ...
    <div class="row ms-0 w-100" style="position: relative;">
          ...
          <div class="card mb-4 wow fadeIn rounded-4">
            ...
            <div class="card-body d-sm-flex justify-content-between shadow bg-light rounded-4">
              ...
              <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
                <span style="color: #E0A100;">HR ACCOUNT</span>
              </h4>
              <!-- 
      ...
      <div class="col-md-12 headertop ms-0">
        <div class="container-fluid">
          ...
          <a href="#" data-bs-toggle="modal" data-bs-target="#modalRegisterForm"><button type="button"
              class="btn btn-success waves-effect waves-light rounded-4"><svg class="" width="20" height="20">
                <use xlink:href="#userPlus" />
              </svg> Add HR Account</button></a>
          <hr>
        </div>
      </div>
              ...
              <tbody>
                ...
                while ($rs = mysqli_fetch_array($result)) {
                  ...
                  <tr>
                    ...
                    <td width='8%'><a href="edit_hr.php?id=<?php echo $id; ?>">
                        <svg class="" width="20" height="20">
                          <use xlink:href="#edit" />
                        </svg></a> | <a href="delete_hr.php?id=<?php echo htmlentities($rs['id']); ?>"
  ...
  <div class="modal fade" id="modalRegisterForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <form action="create_hr.php" method="POST" id="form" enctype="multipart/form-data">
        ...
        <div class="modal-content bg-light rounded-5">
          ...
          <div class="modal-body rounded-4">
            ...
            <div class="form-floating mb-3">
              <input type="text" class="form-control rounded-4" id="name" placeholder="Enter email" name="name" required>
            ...
            <div class="form-floating mb-3">
              <input type="email" class="form-control rounded-4" id="email" placeholder="Enter email" name="hr_user" required>
              <label for="email"><svg class="" width="20" height="20">
            ...
            <div class="form-floating mb-4">
              <span class="custom-file-input">
                <label for="signature" class="form-label me-2 fw-bold">UPLOAD 7 SIGNATURES:</label>
                <input type="file" class="form-control fw-bold rounded-3" id="signature" name="signatureFiles[]"
                  accept=".png, .jpeg, .jpg" multiple required>
              </span>
    ...
    <script>
        document.getElementById('signature').addEventListener('change', function(event) {
            ...
            if (fileInput.files.length > maxFiles) {
                ...
                fileInput.value = ''; // Clear the input to prevent form submission
            } else {
    ...
    <script>
      document.getElementById('signature').addEventListener('change', function () {
        ...
        // Check if exactly 7 files are selected
        if (fileCount !== 7) {
          // Reset the input to clear selected files
          this.value = '';
          alert('Please upload exactly 7 signature images.');
        }
      });
