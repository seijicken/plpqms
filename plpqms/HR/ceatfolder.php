...
<head>
  ...
  <title>PLP | QMS Old Documents</title>
  ...
  <div class="content">
    <div class="row ms-0 w-100" style="position: relative;">
          ...
          <div class="card mb-4 wow fadeIn rounded-4 ">
            ...
            <div class="card-body d-sm-flex justify-content-between shadow bg-light rounded-4 ">
              ...
              <h4 class="mb-2 mb-sm-0 pt-1 fw-bold">
                <span style="color: #E0A100;">OLD DOCUMENTS</span>
              </h4>
              <!-- 
      ...
      <?php
            ...
            $query100 = "SELECT * FROM upload_files WHERE YEAR = '$currentYear' AND ARCHIVE = '0' AND 1=1";
      ...
      <div class="col-md-12 headertop ms-0">
        <div class="container-fluid">
          ...
          <div class="d-flex">
          <form class="d-flex" action="ceatfolder.php" id="manageFiles" method="POST">
                          ...
                          <tr>
                                  ...
                                  <td width="10%">
                                    <a href='view_document.php?controlNumber=<?php echo $controlid; ?>' onclick="viewDocument(event)"
                                      ...
                                      <a href="archive.php?ID=<?php echo $id; ?>" class="btn btn-sm btn-outline-danger" onclick="yesNO(event)"><i
                                              class="fa fa-archive
                                        "></i>
                                          <script>
                                              function yesNO(ev) {
