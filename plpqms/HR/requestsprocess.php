...
<div class="collapse" id="navbarToggleExternalContent" style="background-color: green;">
  <div class="dark p-4">
    ...
    <!-- <li>
      ...
      <li>
        <a href="view_offices.php" class="nav-link text-white">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#building"/></svg>
          Department Offices
        </a>
      </li>
...
$query=mysqli_query($conn,"SELECT * FROM `requests`")or die(mysqli_error($conn));
        ...
        date_default_timezone_set("asia/manila");
         ...
         $year = date("Y",strtotime("+0 HOURS"));
            ...
            $sql = "INSERT INTO requests (requestid,department,request,sendto,timers,email,status,acknowledged, seen_status) VALUES ('$reqid','$foldername','$description','$sendto','$time','$user','Requesting...','0','0')";
