...
<body>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol id="view"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024"
        height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  <div class="row d-md-block w-100 ms-0">
    <div class="d-flex flex-column flex-shrink-0 p-3 pt-4 float-start" style="background-color: green;" id="sidebar">
      ...
      <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
        ...
        <!-- <li>
        <a href="addfile.php" class="nav-link text-white" style="background-color: rgba(202, 202, 202, .65);"> color for navi bar 
  ...
  <div class="col-md-12 headertop ms-0" style=" background-color: green; z-index: -1;" id="headerCustom">
    <header class="ms-0 mb-3 w-100 py-4 mb-6 border-bottom border-5 border-warning" style="height: 80px; z-index: -1">
          ...
          <div class="card mb-4 wow fadeIn rounded-4 ">
            ...
            <div class="card-body d-sm-flex justify-content-between shadow bg-light rounded-4 ">
              ...
              <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4 ">
                <span style="text-decoration: none; color:green; ">ADMIN FILES</span>
                <span>|</span>
                      ...
                      <form action="fileprocess.php" id="add_form" method="post" enctype="multipart/form-data">
                        <div class="col-md-11">
                          <div class="md-form mb-0 text-center ms-5">
                            <input type="hidden" name="email" value="<?php echo ucwords(htmlentities($email)); ?>"
                        ...
                        <center>
                          <div class="col-md-10 mt-4">
                            <div class="input-group">
                              ...
                              <input type="file" class="form-control fw-bold rounded-3" id="myFileUpload"
                                name="myfile[]" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04"
                                aria-label="Upload" accept=".pdf" multiple required>
                        ...
                        <center>
                          ...
                          <div class="col-md-10 mt-2">
                            <div class="input-group">
                              <input list="emailemployee" placeholder="Send to" name="sendTo"
                                class="form-control rounded-3" required>

                              <datalist class="" aria-label="Default select example" id="emailemployee" required
                                style="display: none;">
                                ...
                                $query = "SELECT * FROM personnel_login WHERE NAME!='$username'";
                                ...
                                while ($file = mysqli_fetch_assoc($result)) {
                                  ...
                                  <option name="sentuser" value="<?php echo $sendUser; ?>">Send to User Acc:
                                    <?php echo $sendUser; ?>
                                  </option> <?php } ?>
                                ...
                                while ($file1 = mysqli_fetch_assoc($result1)) {
                                  ...
                                  <option name="sentuser1" value="<?php echo $sendUser1; ?>">Send to Admin Acc:
                                    <?php echo $sendUser1; ?>
                                  </option> <?php } ?>

                                <?php

                                $query2 = "SELECT * FROM hr_user WHERE NAME!='$username'";
                                $result2 = mysqli_query($conn, $query2);
                                while ($file2 = mysqli_fetch_assoc($result2)) {

                                  $sendUser2 = $file2['hr_email'];

                                  ?>

                                  <option name="sentuser2" value="<?php echo $sendUser2; ?>">Send to HR Acc:
                                    <?php echo $sendUser2; ?>
                                  </option> <?php } ?>
                        ...
                        <center>
                          <div class="col-md-10 mt-2">
                            <input type="text" style="display: none;" class="form-control rounded-3" name="linkname"
                              id="linknam" placeholder="Enter Link Name" maxlength="40">
                            <div>
                        </center>

                        <center>
                          <div class="col-md-10 mt-2">
                            <textarea class="form-control rounded-3" id="exampleFormControlTextarea1" name="description"
                              rows="4" placeholder="Enter Description Message" style="resize: none;"></textarea>
                          </div>
                        </center>

                        <div class="row d-flex justify-content-center">
                          <div class="col-md-5 mt-2">
                            <select class="form-select fw-bold rounded-3" id="customOffice" name="department"
                              ...
                              while ($file = mysqli_fetch_assoc($result)) {
                                ...
                                <option value="<?php echo $offices; ?>"><?php echo $offices; ?> Folder</option>
                              <?php } ?>
                          ...
                          <div class="col-md-5 mt-2">
                            <input type="text" maxlength="8" onkeypress="{return isNumberKey(event)}"
                              inputmode="numeric" class="form-control rounded-3" id="email"
                              placeholder="ID Control# 8 Digits Only" name="controlno" value="" disabled>
            ...
            function isNumberKey(evt)
  {
     ...
     return true;
                        ...
                        <button type="submit"
                          class="btn fw-bold btn-rounded btn-block mt-3 mb-3 waves-effect z-depth-0 rounded-3"
                          name="save" id="addnew" style="background:#E0A100;"><i class="fa fa-upload"></i> UPLOAD
                          FILE</button>
                        <div id="warnings">
                          <p class="fw-bold" style="font-size: 12px"><b>File Type:</b>
                            <font color="red"><i>.pdf</i></font>
                          </p>
                          <p class="fw-bold" style="font-size: 12px; margin-top:-15px;"><b>Max File Upload: </b>
                            <font color="red"><i>1 Files Only!!</i></font>
                          </p>
                        </div>
                      </form>
                    </div>
      ...
      <div class="modal-dialog modal-dialog-centered rounded-5" role="document">
        <div class="modal-content bg-light rounded-5">
          ...
          <div class="modal-body rounded-4">
            ...
            <button class=" col md-6 form-floating mb-3" onclick="redirectToSignature()">Go to Signature.php</button>

            <script>
              // Define the JavaScript function to redirect to signature.php
              function redirectToSignature() {
                // Use the window.location.href property to navigate to the desired page
