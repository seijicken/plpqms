   ...
   <div class="container-fluid mt-5 rounded-4">
      ...
      <div class="card mb-4 wow fadeIn rounded-4">
        ...
        <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
            <a href="home.php" style="text-decoration: none; color:green; ">HOME PAGE</a>
            <span>|</span>
...
<table id="dtable" class = "table table-striped w-100" >
 ...
 <script>
    ...
    swalWithBootstrapButtons.fire({
        ...
        text: "This File is Property of PLP and Must be Used for PLP educational purposes only.",
        icon: 'warning',
