          ...
          <div class="card mb-4 wow fadeIn rounded-4 ">
            ...
            <div class="card-body d-sm-flex justify-content-between shadow bg-light rounded-4 ">
              ...
              <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4 ">
                <span style="text-decoration: none; color: #424242; ">MANAGE ALL FILES</span>
                <span>|</span>
                ...
                <span class="input-group-btn">
                  <a href="ceatfolder.php" class="text-black">
                    <button class="d-inline-block fw-bold btn waves-effect waves-light rounded-4 "
                      ...
                      Back to Recent Documents</button>
                  </a>
                </span>
                <span class="input-group-btn">
      ...
      <div class="col-md-12">
                  ...
                  if ($offices == "all") {
                    ...
                    while ($file = mysqli_fetch_array($result)) {
                      ...
                      <tr>
                        ...
                        <td width="5%"><?php echo $uploads; ?></td>
                        <td width="5%"><?php echo $time; ?></td>
                        <td width="5%"><?php echo $download; ?></td>
                        <td width="5%"><?php echo $action; ?></td>
        ...
        WHERE (DEPARTMENT = '$offices' AND YEAR < $currentYear AND ARCHIVE = '0') GROUP BY ID DESC";
                    ...
                    while ($file = mysqli_fetch_array($result)) {
                      ...
                      <td width="5%"><?php echo $department; ?></td>
                      <td width="5%"><?php echo $uploads; ?></td>
                      <td width="5%"><?php echo $time; ?></td>
                  ...
                  $query = "SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,SIZE,EMAIL,ADMIN_STATUS,TIMERS,YEAR,DOWNLOAD,SIZE,SEEN_STATUS FROM upload_files WHERE YEAR < $currentYear AND ARCHIVE = '0' group by ID desc";
                  $result = mysqli_query($conn, $query);
                  while ($file = mysqli_fetch_array($result)) {
                    $id = $file['ID'];
                    $controlid = $file['controlNumber'];
