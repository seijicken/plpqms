...
$query=mysqli_query($conn,"SELECT * FROM  personnel_login WHERE email_address = '$username'")or die(mysqli_error($conn));
  ...
  confirmButtonColor:'#00396D',
   ...
   timer:2500
			  ...
			  if(password_verify($password, $row["user_password"]))  
                 {
           $resetpass = mysqli_query($conn,"SELECT * FROM newlycreatedpersonnel WHERE email ='$username'")or die(mysqli_error($conn));
...
<header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom border-5 border-warning" style="background-color: green;">
      <a href="/" class="d-flex align-items-center ms-5 mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
        ...
        <span class="fs-4 ms-2 fw-bold text-light" style="font-family: arial;">PLP | DOCUMENT MANAGEMENT SYSTEM</span>
      </a>
    </header>
</main>
