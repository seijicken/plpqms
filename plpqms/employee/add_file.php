...
<div class="row d-md-block w-100 ms-0">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
      ...
      <li>
      <a href="add_file.php" class="nav-link dropdown-item text-white" style="background-color: rgba(202, 202, 202, .65);" aria-current="page">
...
<h5 class="card-header info-color rounded-4  white-text text-center py-4">
  ...
  <div class=" card-body rounded-4  px-lg-6 pt-0">
    <div class="container">
      ...
      <!-- Start of Image Processing and CNN; Redirects to process.php -->
...
<div class="col-md-10 mt-2">
 ...
 <center>
 <div class="col-md-10 mt-2">
 <input type="text" style="display: none;" class="form-control rounded-3" name="linkname" id="linknam" placeholder="Enter Link Name" maxlength="40">
 <div>
  </center>
