...
<div class="row d-md-block w-100 ms-0">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
      ...
      <li>
        <a href="dashboard.php" class="nav-link text-white" style="background-color: rgba(202, 202, 202, .65);" aria-current="page">
...
<div class="collapse" id="navbarToggleExternalContent" style="background-color: green;">
  <div class="dark p-4">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
      ...
      <li>
        <a href="dashboard.php" class="nav-link" style="background-color: rgba(202, 202, 202, .65); color: #fff;">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#speedometer2"/></svg>
          Dashboard
        </a>
      </li>
      ...
      <div class="card mb-4 wow fadeIn rounded-4">
        ...
        <div class="card-body d-md-flex justify-content-between shadow bg-light rounded-4">
          ...
          <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
            <a href="home.php" style="text-decoration: none; color:#424242; ">DASHBOARD</a>
          </h4>
<!-- 
...
<div class="modal fade" id="modalRegisterForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <form action="create_admin.php" method="POST" id="form" enctype="multipart/form-data">
  <div class="modal-dialog modal-dialog-centered rounded-5" role="document">
    ...
    <div class="form-floating mb-3">
        <input type="file" class="form-control rounded-4" id="sign" accept="image/*" name="admin_sign">
    </div>
