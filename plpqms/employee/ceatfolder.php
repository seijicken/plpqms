...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <symbol id="left-arrow" viewBox="0 0 16 16">
    <path d="M11.854 12.146a.5.5 0 0 0 0-.708L6.707 8l5.147-5.146a.5.5 0 0 0-.708-.708l-5.5 5.5a.5.5 0 0 0 0 .708l5.5 5.5a.5.5 0 0 0 .708 0z"/>
  </symbol>
 ...
 <symbol id="right"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/></svg></symbol>
     ...
     <symbol id="left">  <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"> <path d="M585.4 278.6c-12.5-12.5-12.5-32.8 0-45.3l160-160c12.5-12.5 32.8-12.5 45.3 0s12.5 32.8 0 45.3L685.2 224H992c17.7 0 32 14.3 32 32s-14.3 32-32 32H685.3L790.6 393.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0l-160-160z"/>
  </svg>
</symbol>
...
<div class="row d-md-block w-100 ms-0">
    ...
    Upload Documents
               ...
               <li>
        <a href="ceatfolder.php" class="nav-link text-white" style="background-color: rgba(202, 202, 202, .65);" aria-current="page">
...
<div class="collapse" id="navbarToggleExternalContent" style="background-color: green;">
  <div class="dark p-4">
      ...
      <!-- <li>
        <a href="addfile.php" class="nav-link text-white">
          ...
          Add Document
               ...
               <li>
        <a href="ceatfolder.php" class="nav-link text-white" style="background-color: rgba(202, 202, 202, .65);"">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#folder"/></svg>
          Manage All Files
        </a>
      </li>
    ...
    <li><a class="dropdown-item" href="#" onclick="confirmSignOut()">Sign out <svg class="bi pe-none me-2" width="15" height="15"><use xlink:href="#signout"/></svg></a>
<script>
function confirmSignOut() {
    const swalWithBootstrapButtons = Swal.mixin({
        customClass: {
   ...
   <div class="container-fluid mt-5 rounded-4">
      ...
      <div class="card mb-4 wow fadeIn rounded-4">
        ...
        <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
            <a href="home.php" style="text-decoration: none; color: #424242;">MANAGE ALL FILES </a>
                ...
                <span class="input-group-btn">
                  <a href="pastFiles.php" class="text-black">
                    <button class="d-inline-block fw-bold btn waves-effect waves-light rounded-4"
                      style="background-color: #E0A100;">Old Documents
                  ...
                  <span class="input-group-btn">
                  <a href="ArhieveFile.php" class="text-black">
                  ...
                  if ($offices != "All") {
                    ...
                    while ($file = mysqli_fetch_array($result)) {
                      ...
                      <tr>
                        ...
                        <td width="8%">
                           <a href='download.php?file_id=<?php echo $id; ?>' onclick="downloadYes(event)"
