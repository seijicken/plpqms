...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="../assets/img/PLP.png">
            <link rel="icon" type="image/x-icon" href="../assets/img/PLP.png"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css">
...
<div id="carouselExampleIndicators" class="col-6 carousel slide" data-bs-ride="true" style="margin-top:-171px;">
  ...
  <div class="container login-sec">
    ...
    <div class=" text-center form-floating mb-2">
        ...
        <button type="button" onclick="chooseLogin_employee()" id="loginEmploy" class=" btn col-5 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold;">Personnel   <i class="fa fa-sign-in" aria-hidden="true"></i></button>

        <button type="button" onclick="chooseLogin_admin()" id="loginAdmin" class=" btn col-5 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold;">Admin   <i class="fa fa-sign-in" aria-hidden="true"></i></button> <br>
        <br>
         <button type="button" onclick="chooseLogin_HR()" id="loginHR" class=" btn col-10 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold;"> Human Resource (HR)    <i class="fa fa-sign-in" aria-hidden="true"></i></button>
    </div>
    ...
    <div id="pwdDiv" class="form-floating mt-3 mb-3" style="display: none; position: absolute;">
      ...
      <a href="forgotPass.php" class="mt-2" id="forgotpass" style="display:none" textContent=""> Forgot Password?</a>
    </div>
...
function chooseLogin_employee() {
  ...
  forgotpass.href = "forgotPassPersonnel.php"; // Employee forgot password link
...
forgotpass.href = "forgotPassHR.php"; // Employee forgot password link
...
document.getElementById("form").action = "HR/login.php";
