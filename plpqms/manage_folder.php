...
<div class="row d-md-block w-100 ms-0">
    <div class="col-md-2 d-flex flex-column min-vh-100 flex-shrink-2 p-3 pt-4 float-start" style=" background-color: green;">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1">o
      ...
      <a href="manage_folder.php" class="nav-link" style="background-color: rgba(202, 202, 202, .65); color: #fff;">
    ...
    <div class="dropdown">
      ...
      <div class="col-md-10 headertop ms-0 float-end " style= " background-color: green; z-index: -1;">
...
<!-- Material form login -->
   <br><br>
      ...
      <div class="col-md-10 footerTop ms-0 position-absolute bottom-0 end-0" style= "background-color: green; z-index: -1">
  ...
  <div class="modal-dialog modal-dialog-centered border-bottom border-top border-5 rounded-4" role="document">
    <div class="modal-content bg-light">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold" style="color: green;"><i class="fas fa-user-plus"></i> ADD EMPLOYEE ACCOUNT</h4>
